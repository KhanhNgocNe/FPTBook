...
namespace FPTBook.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult UpdateQuantity(FormCollection form)
        {
            ...
            Book stock = _db.Books.FirstOrDefault(c => c.bookID == idbook);
            if( quantity > stock.stock_quantity)
            {
                return Content("<script>alert('Larger number of books in stock');window.location.replace('/Cart/ViewCart');</script>");
            }
        ...
        public ActionResult Checkout(FormCollection form)
        {
            try
            {
                ...
                {
                    return Content("<script>alert('Please, choose product ');window.location.replace('/Cart/ViewCart');</script>");
                }
            }
